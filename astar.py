...
class Cell():
    ...
    def draw(self):
        COST_TO_DRAW = ''
        # COST_TO_DRAW = self.g_cost #the cost of getting to the cell from the start
        # COST_TO_DRAW = self.h_cost #how far the cell is from the goal, or the projected cost of getting to the goal from here
        COST_TO_DRAW = self.f_cost #a measure of 'goodness' of a cell - the cost of getting there + its distance from the goal
        line_width = 2
